...
## new_task
Description: Create a new task with a specified starting mode and initial message. This instructs the system to create a new Cline instance in the given mode with the provided message.
