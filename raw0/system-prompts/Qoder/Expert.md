...
The output will include file path, and line summary.
...
- You need to understand type definitions, interfaces, or imported functions used by the file)
...
### fetch_content
Fetches the main content from a web page.The Web page must be an HTTP or HTTPS URL that points to a valid internet resource accessible via web browser. This tool is useful for summarizing or analyzing the content of a webpage.
%!(EXTRA int=10000)
...
You should make clear what the edit is, while also minimizing the unchanged code you write.
