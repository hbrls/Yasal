...
- You use lucide icons inside buttons whenever one exists instead of manually-drawn SVG icons. If a library is enabled in an existing application, you use icons from that library.
