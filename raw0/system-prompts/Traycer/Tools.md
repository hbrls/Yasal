...
## 来源：traycer-ai-plan_mode_tools-Unclassified.md
...
```
  ...
  "web_search": {
    "description": "Performs web searches to find relevant information and documentation for the given query. This tool helps gather external knowledge useful for solving tasks, especially for obtaining latest information or documentation.",
    "parameters": {
      "query": {
        "description": "The search query to look up on the web.",
        "type": "string"
  ...
  "find_references": {
    ...
    "parameters": {
      "line": {
        "anyOf": [
          {
            "description": "The line number where the symbol is mentioned. This field is optional. If omitted, it will match the first occurence of the symbol in the file.",
            "type": "number"
          },
          {
            "type": "null"
